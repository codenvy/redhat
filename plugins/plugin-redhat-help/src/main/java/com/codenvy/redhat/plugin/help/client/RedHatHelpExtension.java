...
public class RedHatHelpExtension {
    ...
    /**
     * Dependency on {@link HelpAboutExtension} allows to initialize all actions in the first instance.
     * Then simple remove {@link RedirectToSupportAction} from the help menu.
     */
    @Inject
    public RedHatHelpExtension(ActionManager actionManager,
